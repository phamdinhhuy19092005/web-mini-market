    ...
    <div id="k_aside_menu" class="k-aside-menu" data-kmenu-vertical="1" data-kmenu-scroll="1" data-kmenu-dropdown-timeout="500">
        <ul class="k-menu__nav">
            <li class="k-menu__item {{ request()->routeIs('bo.web.dashboard') ? 'k-menu__item--active' : '' }}" aria-haspopup="true">
                <a target="_blank" href="{{ route('bo.web.dashboard') }}" class="k-menu__link">
            ...
            <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.category-groups.*', 'bo.web.categories.*', 'bo.web.countries.*', 'bo.web.brands.*') ? 'k-menu__item--open k-menu__item--active' : '' }}" aria-haspopup="true" data-kmenu-submenu-toggle="hover">
                ...
                <div class="k-menu__submenu">
                    ...
                    <ul class="k-menu__subnav">
                        <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.category-groups.*', 'bo.web.categories.*') ? 'k-menu__item--open' : '' }}" aria-haspopup="true" data-kmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="k-menu__link k-menu__toggle">
                        ...
                        <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.attributes.*', 'bo.web.categories.*') ? 'k-menu__item--open' : '' }}" aria-haspopup="true" data-kmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="k-menu__link k-menu__toggle">
                                <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
            ...
            <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.banners.*', 'bo.web.menu*') ? 'k-menu__item--open k-menu__item--active' : '' }}" aria-haspopup="true" data-kmenu-submenu-toggle="hover">
                <a href="javascript:;" class="k-menu__link k-menu__toggle">
                ...
                <div class="k-menu__submenu">
                    ...
                    <ul class="k-menu__subnav">
                        ...
                        <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.menu*') ? 'k-menu__item--open' : '' }}" aria-haspopup="true" data-kmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="k-menu__link k-menu__toggle">
                                <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
                            ...
                            <div class="k-menu__submenu">
                                ...
                                <ul class="k-menu__subnav">
                                    ...
                                    {{-- <li class="k-menu__item {{ request()->routeIs('bo.web.submenu-groups.*') ? 'k-menu__item--active' : '' }}" aria-haspopup="true">
                                        <a href="{{ route('bo.web.submenu-groups.index') }}" class="k-menu__link">
                                            <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
                                            <span class="k-menu__link-text">Nhóm Menu phụ</span>
                                        </a>
                                    </li>
                                    <li class="k-menu__item {{ request()->routeIs('bo.web.menus.*') ? 'k-menu__item--active' : '' }}" aria-haspopup="true">
                                        <a href="{{ route('bo.web.menus.index') }}" class="k-menu__link">
                                            <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
                                            <span class="k-menu__link-text">Menu</span>
                                        </a>
                                    </li> --}}
                                </ul>
                            </div>
            ...
            <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.post-categories.*', 'bo.web.posts.*', 'bo.web.pages.*', 'bo.web.faq*') ? 'k-menu__item--open k-menu__item--active' : '' }}" aria-haspopup="true" data-kmenu-submenu-toggle="hover">
                <a href="javascript:;" class="k-menu__link k-menu__toggle">
                ...
                <div class="k-menu__submenu">
                    ...
                    <ul class="k-menu__subnav">
                        ...
                        <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.faq*') ? 'k-menu__item--open' : '' }}" aria-haspopup="true" data-kmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="k-menu__link k-menu__toggle">
                                <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
            ...
            <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.shipping*') ? 'k-menu__item--open k-menu__item--active' : '' }}" aria-haspopup="true" data-kmenu-submenu-toggle="hover">
                <a href="javascript:;" class="k-menu__link k-menu__toggle">
                ...
                <div class="k-menu__submenu">
                    <span class="k-menu__arrow"></span>
                    <ul class="k-menu__subnav">
                        <li Building on the active state logic, here is the continuation of the modified sidebar code with active state handling for the remaining sections:

```html
                        <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.shipping*') ? 'k-menu__item--open' : '' }}" aria-haspopup="true" data-kmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="k-menu__link k-menu__toggle">
                                <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
                                <span class="k-menu__link-text">Cài đặt vận chuyển</span>
                                <i class="k-menu__ver-arrow la la-angle-right"></i>
                            </a>
                            <div class="k-menu__submenu">
                                <span class="k-menu__arrow"></span>
            ...
            <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.system*') ? 'k-menu__item--open k-menu__item--active' : '' }}" aria-haspopup="true" data-kmenu-submenu-toggle="hover">
                ...
                <div class="k-menu__submenu">
                    <span class="k-menu__arrow"></span>
                    <ul class="k-menu__subnav">
                        {{-- <li class="k-menu__item {{ request()->routeIs('bo.web.system-config*') ? 'k-menu__item--active' : '' }}" aria-haspopup="true">
                            <a href="{{ route('bo.web.system-config.index') }}" class="k-menu__link">
                                <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
                                <span class="k-menu__link-text">Cấu hình hệ thống</span>
                            </a>
                        </li> --}}
                        {{-- <li class="k-menu__item {{ request()->routeIs('bo.web.system-currencies.*') ? 'k-menu__item--active' : '' }}" aria-haspopup="true">
                            <a href="{{ route('bo.web.system-currencies.index') }}" class="k-menu__link">
                                <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
                                <span class="k-menu__link-text">Tiền tệ hệ thống</span>
                            </a>
                        </li> --}}
                    </ul>
                </div>

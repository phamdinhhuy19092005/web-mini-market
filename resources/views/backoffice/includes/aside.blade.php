...
<div class="k-aside-menu-wrapper k-grid__item k-grid__item--fluid" id="k_aside_menu_wrapper">
    <div id="k_aside_menu" class="k-aside-menu" data-kmenu-vertical="1" data-kmenu-scroll="1" data-kmenu-dropdown-timeout="500">
        <ul class="k-menu__nav">
            ...
            <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.attributes.*', 'bo.web.attribute-values.*', 'bo.web.inventories.*') ? 'k-menu__item--open k-menu__item--active' : '' }}"
                aria-haspopup="true"
                ...
                <div class="k-menu__submenu">
                    ...
                    <ul class="k-menu__subnav">
                        <!-- Attributes -->
                        <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.attributes.*', 'bo.web.attribute-values.*') ? 'k-menu__item--open' : '' }}"
                            aria-haspopup="true"
                            data-kmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="k-menu__link k-menu__toggle">
                        ...
                        <!-- Coupons -->
                        <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.coupons.*', 'bo.web.discounts.*') ? 'k-menu__item--open' : '' }}"
                            aria-haspopup="true"
                            data-kmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="k-menu__link k-menu__toggle">
                                <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
            ...
            <!-- Product Management -->
            <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.category-groups.*', 'bo.web.categories.*', 'bo.web.sub-categories.*', 'bo.web.attributes.*', 'bo.web.attribute-values.*', 'bo.web.products.*', 'bo.web.brands.*', 'bo.web.inventories.*') ? 'k-menu__item--open k-menu__item--active' : '' }}"
                aria-haspopup="true"
                data-kmenu-submenu-toggle="hover">
                <a href="javascript:;" class="k-menu__link k-menu__toggle">
                    <i class="k-menu__link-icon flaticon2-box"></i>
                ...
                <div class="k-menu__submenu">
                    ...
                    <ul class="k-menu__subnav">
                        <!-- Categories -->
                        <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.category-groups.*', 'bo.web.categories.*', 'bo.web.sub-categories.*') ? 'k-menu__item--open' : '' }}"
                            aria-haspopup="true"
                            data-kmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="k-menu__link k-menu__toggle">
                                <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
            ...
            <!-- Order Management -->
            <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.orders.*', 'bo.web.carts.*') ? 'k-menu__item--open k-menu__item--active' : '' }}"
                aria-haspopup="true"
                data-kmenu-submenu-toggle="hover">
                <a href="javascript:;" class="k-menu__link k-menu__toggle">
            ...
            <!-- Interface -->
            <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.banners.*', 'bo.web.menu-groups.*') ? 'k-menu__item--open k-menu__item--active' : '' }}"
                aria-haspopup="true"
                data-kmenu-submenu-toggle="hover">
                <a href="javascript:;" class="k-menu__link k-menu__toggle">
            ...
            <!-- Utilities -->
            <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.post-categories.*', 'bo.web.posts.*', 'bo.web.pages.*', 'bo.web.faq-topics.*', 'bo.web.faqs.*') ? 'k-menu__item--open k-menu__item--active' : '' }}"
                aria-haspopup="true"
                data-kmenu-submenu-toggle="hover">
                <a href="javascript:;" class="k-menu__link k-menu__toggle">
                ...
                <div class="k-menu__submenu">
                    ...
                    <ul class="k-menu__subnav">
                        <!-- Blog -->
                        <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.post-categories.*', 'bo.web.posts.*') ? 'k-menu__item--open' : '' }}"
                            aria-haspopup="true"
                            data-kmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="k-menu__link k-menu__toggle">
                                <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
                        ...
                        <!-- FAQs -->
                        <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.faq-topics.*', 'bo.web.faqs.*') ? 'k-menu__item--open' : '' }}"
                            aria-haspopup="true"
                            data-kmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="k-menu__link k-menu__toggle">
                                <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
            ...
            <!-- Shipping -->
            <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.shipping-zones.*', 'bo.web.shipping-rates.*') ? 'k-menu__item--open k-menu__item--active' : '' }}"
                aria-haspopup="true"
                data-kmenu-submenu-toggle="hover">
                <a href="javascript:;" class="k-menu__link k-menu__toggle">
                ...
                <div class="k-menu__submenu">
                    ...
                    <ul class="k-menu__subnav">
                        ...
                        <li class="k-menu__item {{ request()->routeIs('bo.web.shipping-options.*') ? 'k-menu__item--active' : '' }}" aria-haspopup="true">
                            <a href="{{ route('bo.web.shipping-rates.index') }}" class="k-menu__link">
                                <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>
                                <span class="k-menu__link-text">Phương thức vận chuyển</span>
                            </a>
                        </li>
                    </ul>
                </div>
                        ...
                        <li class="k-menu__item k-menu__item--submenu {{ request()->routeIs('bo.web.category-groups.*', 'bo.web.categories.*', 'bo.web.sub-categories.*') ? 'k-menu__item--open' : '' }}"
                            ...
                            <div class="k-menu__submenu">
                                ...
                                <ul class="k-menu__subnav">
                                    ...
                                    <li class="k-menu__item {{ request()->routeIs('bo.web.payment-providers.*') ? 'k-menu__item--active' : '' }}" aria-haspopup="true">
                                        <a href="{{ route('bo.web.payment-options.index') }}" class="k-menu__link">
                                            <i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i>

                ...
                <div class="k-portlet">
                    <div class="k-portlet__head">
                        <div class="k-portlet__head-label">
                            <h3 class="k-portlet__head-title">Edit Faqs</h3>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('bo.web.faqs.update', $faq->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="question" id="question" class="form-control" placeholder="Nhập câu hỏi" autocomplete="off"
                                    value="{{ old('name', $faq->question) }}">
                            </div>

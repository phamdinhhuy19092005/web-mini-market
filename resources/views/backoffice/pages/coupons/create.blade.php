                ...
                <div class="k-portlet">
                    <div class="k-portlet__head">
                        <div class="k-portlet__head-label">
                            <h3 class="k-portlet__head-title">Tạo mã giảm giá</h3>
                        </div>
                    </div>

                    <!-- Begin::Form -->
                    <form action="{{ route('bo.web.coupons.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="k-portlet__body">
                            <div class="form-group">
                                <label for="title">Tiêu đề <span class="text-danger">*</span></label>
                                <input type="text" placeholder="Nhập tiêu đề" name="title" id="title" class="form-control" autocomplete="off" value="{{ old('title') }}" required>
                                @error('title')
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control text-uppercase" autocomplete="off" value="{{ old('code') }}" required>
                                    @error('code')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="number" name="discount_value" id="discount_value" class="form-control"
                                           placeholder="Nhập giá trị giảm giá" step="0.01" min="0" value="{{ old('discount_value') }}" required>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="number" name="usage_limit" id="usage_limit" class="form-control"
                                           placeholder="Nhập số lần sử dụng tối đa (tùy chọn)" min="0" value="{{ old('usage_limit') }}">
                                    @error('usage_limit')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="k-portlet__foot">
                            <div class="k-form__actions">
                                ...
                                <a href="{{ route('bo.web.coupons.index') }}" class="btn btn-secondary">Hủy</a>
                            </div>
                        </div>
                    </form>
                    <!-- End::Form -->

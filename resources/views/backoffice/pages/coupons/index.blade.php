...
@php
    $title = __('Quản lý mã giảm giá');
    $breadcrumbs = [
        ['label' => __('Mã giảm giá')],
        ['label' => __('Mã giảm giá nhập tay')],
        ['label' => __('Quản lý mã giảm giá')],
    ];
@endphp
            ...
            <div class="k-portlet k-portlet--mobile">
                <div class="k-portlet__head k-portlet__head--lg">
                    ...
                    <div class="k-portlet__head-toolbar">
                        <a href="{{ route('bo.web.coupons.create') }}" class="btn btn-primary btn-bold btn-upper btn-font-sm">
                            <i class="flaticon2-add-1"></i> {{ __('Tạo mã giảm giá') }}
                        </a>
                    </div>
                </div>
                <div class="k-portlet__body k-portlet__body--fit p-4">
                    <table id="table_coupons_index" class="table table-striped table-bordered table-hover table-checkable datatable"
                           data-request-url="{{ route('bo.api.coupons.index') }}" data-searching="true">
                        <thead>
                            <tr>

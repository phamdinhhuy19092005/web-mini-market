            ...
            <div class="k-portlet__body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <!-- Quantity in Unit -->
                        <div class="form-group">
                            <label for="quantity_in_unit">{{ __('Số lượng trong đơn vị') }} <span class="text-danger">*</span></label>
                            <input type="number" name="quantity_in_unit" id="quantity_in_unit" class="form-control" placeholder="{{ __('Nhập số lượng trong đơn vị') }}" autocomplete="off" value="{{ old('quantity_in_unit', $inventory->quantity_in_unit) }}" required min="1">
                    ...
                    <!-- Unit Type -->
                        <div class="form-group">
                            <label for="unit_type">{{ __('Loại đơn vị') }} <span class="text-danger">*</span></label>
                            <input type="text" name="unit_type" id="unit_type" class="form-control" placeholder="{{ __('Nhập loại đơn vị') }}" autocomplete="off" value="{{ old('unit_type', $inventory->unit_type) }}" required>
                            @error('unit_type')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>

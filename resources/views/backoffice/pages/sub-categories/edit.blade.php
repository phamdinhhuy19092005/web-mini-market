                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                   ...
                                   <textarea name="description" id="description" class="form-control" rows="4">{{ old('description', $sub_category->description) }}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="k-switch">
                                        <label>
                                            <input type="checkbox" name="status" value="1" {{ old('status', $sub_category->status) ? 'checked' : '' }}>
                                            <span></span>
                                        </label>
                                    </div>
                                    @error('status')

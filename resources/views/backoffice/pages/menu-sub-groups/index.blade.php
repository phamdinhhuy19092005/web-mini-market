                                    ...
                                    <table id="table_mennu_groups_index" data-searching="true" data-request-url="" class="table table-striped table-bordered table-hover table-checkable" role="grid" aria-describedby="table_mennu_groups_index_info">
                                       <thead>
                                            <tr role="row">
                                                ...
                                                <th data-property="group" class="group sorting text-center" tabindex="0" aria-controls="table_mennu_groups_index" rowspan="1" colspan="1" aria-label="Nhóm: activate to sort column ascending">Nhóm</th>

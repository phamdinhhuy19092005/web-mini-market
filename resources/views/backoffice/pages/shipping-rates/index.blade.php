...
@php
    $title = __('Quản lý phí vận chuyển');
    $breadcrumbs = [
        ['label' => __('Vận chuyển')],
        ['label' => __('Cài đặt vận chuyển')],
        ['label' => __('Quản lý phí vận chuyển')],
    ];
@endphp
            ...
            <div class="k-portlet k-portlet--mobile">
                <div class="k-portlet__head k-portlet__head--lg">
                    <div class="k-portlet__head-label">
                        <h3 class="k-portlet__head-title">{{ __('Danh sách phí vận chuyển') }}</h3>
                    </div>
                    <div class="k-portlet__head-toolbar">
                        <a href="{{ route('bo.web.shipping-rates.create') }}" class="btn btn-primary btn-bold btn-upper btn-font-sm">
                            <i class="flaticon2-add-1"></i> {{ __('Tạo phí vận chuyển') }}
                        </a>
                    </div>
                </div>
                <div class="k-portlet__body k-portlet__body--fit p-4">
                    <table id="table_shipping_rates_index" class="table table-striped table-bordered table-hover table-checkable datatable"
                           data-request-url="{{ route('bo.api.shipping-rates.index') }}" data-searching="true">
                        <thead>
                            <tr>

                ...
                <div class="k-portlet">
                    <div class="k-portlet__head">
                        <div class="k-portlet__head-label">
                            <h3 class="k-portlet__head-title">Tạo Cước phí Vận chuyển</h3>
                        </div>
                    </div>

                    <!--begin::Form-->
                    <form action="{{ route('bo.web.shipping-rates.store') }}" method="POST">
                        @csrf
                                    ...
                                    <select name="shipping_zone_id" id="shipping_zone_id" 
                                        ...
                                        @foreach($shippingZones as $shippingZone)
                                            <option value="{{ $shippingZone->id }}" 
                                                    {{ old('shipping_zone_id') == $shippingZone->id ? 'selected' : '' }}>
                                                {{ $shippingZone->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('bo.web.shipping-rates.index') }}" 

...
@php
    $title = __('Tạo vùng giao hàng');
    $breadcrumbs = [
        ['label' => __('Giao hàng')],
        ['label' => __('Cài đặt giao hàng')],
        ['label' => __('Tạo vùng giao hàng')],
    ];
@endphp
                ...
                <div class="k-portlet">
                    <div class="k-portlet__head">
                        <div class="k-portlet__head-label">
                            <h3 class="k-portlet__head-title">{{ __('Tạo vùng giao hàng') }}</h3>
                        </div>
                    </div>

                    <!--begin::Form-->
                    <form action="{{ route('bo.web.shipping-zones.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('bo.web.shipping-zones.index') }}" class="btn btn-secondary">{{ __('Hủy') }}</a>
                        </div>
                    </form>
                    <!--end::Form-->
                </div>
